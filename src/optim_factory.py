...
def get_parameter_groups(model, weight_decay=1e-5, skip_list=(), get_num_layer=None, get_layer_scale=None):
    ...
    logging.log(logging.DEBUG, "Param groups = %s" % json.dumps(parameter_group_names, indent=2))
...
def create_optimizer(args, model, get_num_layer=None, get_layer_scale=None,  skip_list=None):
    ...
    if args.trainable_bias_and_bn_params: # Filter bias and bn from model's trainable parameters
        skip = {}
